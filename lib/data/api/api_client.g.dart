...
class _ApiClient implements ApiClient {
  _ApiClient(
    ...
    baseUrl ??= 'http://54.147.151.107:8000';
  }
  ...
  Future<UserLoginResponse> login(UserLoginRequest request) async {
    ...
    final _options = _setStreamType<UserLoginResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late UserLoginResponse _value;
    try {
      _value = UserLoginResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<UserRegisterResponse> registerUser(
    ...
    final _options = _setStreamType<UserRegisterResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<List<CheckinResponse>> getCheckIns(
    String? authorization,
    int userId,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CheckinResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<CheckinResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              CheckinResponse.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<List<GetReminderResponse>> getReminder(
    String? authorization,
    int userId,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GetReminderResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GetReminderResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              GetReminderResponse.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
