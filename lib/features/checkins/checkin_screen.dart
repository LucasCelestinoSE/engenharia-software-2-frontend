                  ...
                  children: [
                    ...
                    Row(
                        ...
                        children: [
                          FellingsText(
                            fellingName: "Feliz",
                            isSelected: checkinProvider.selectedFeelings.contains("Feliz"),
                            onTap: () => checkinProvider.toggleFeeling("Feliz"),
                          ),
                          FellingsText(
                            fellingName: "Triste", 
                            isSelected: checkinProvider.selectedFeelings.contains("Triste"),
                            onTap: () => checkinProvider.toggleFeeling("Triste"),
                          ),
                          FellingsText(
                            fellingName: "Ansioso",
                            isSelected: checkinProvider.selectedFeelings.contains("Ansioso"),
                            onTap: () => checkinProvider.toggleFeeling("Ansioso"),
                          ),
                          FellingsText(
                            fellingName: "Calmo",
                            isSelected: checkinProvider.selectedFeelings.contains("Calmo"),
                            onTap: () => checkinProvider.toggleFeeling("Calmo"),
                          ),
                          FellingsText(
                            fellingName: "Irritado",
                            isSelected: checkinProvider.selectedFeelings.contains("Irritado"),
                            onTap: () => checkinProvider.toggleFeeling("Irritado"),
                          ),
                        ],
                      ),
                    SizedBox(height: 20),
